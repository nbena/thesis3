...
\inputminted[tabsize=1, breaklines, fontsize=\footnotesize]{python}{code_samples/nftables.py}

\begin{figure}
	\includegraphics[scale=0.65]{img/sequence_mapping}
	\caption[Diagramma di interazione: assegnato reti]{Diagramma di interazione che mostra
...
\inputminted[tabsize=4, breaklines]{lua}{code_samples/works.lua}
